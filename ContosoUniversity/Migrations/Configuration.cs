...
namespace ContosoUniversity.Migrations
{
    internal sealed class Configuration : DbMigrationsConfiguration<SchoolContext>
    {
        ...
        protected override void Seed(SchoolContext context)
        {
            ...
            foreach (var e in enrollments)
            {
                var enrollmentInDataBase =
                    context.Enrollments.Where(s => s.Student.Id == e.StudentID && s.Course.CourseID == e.CourseID)
                        .SingleOrDefault();
        ...
        private void AddOrUpdateInstructor(SchoolContext context, string courseTitle, string instructorName)
        {
            ...
            if (inst == null) crs.Instructors.Add(context.Instructors.Single(i => i.LastName == instructorName));
        }
    }
}